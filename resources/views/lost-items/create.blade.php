...
<div class="container py-4">
    <h2 class="mb-4">Lapor Barang Hilang</h2>

    <form action="{{ route('lost-items.store') }}" method="POST" enctype="multipart/form-data" class="card p-4 shadow-sm">
        @csrf
        ...
        <div class="mb-3">
            <label for="lokasi" class="form-label">Lokasi Hilang *</label>
