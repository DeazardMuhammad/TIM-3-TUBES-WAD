...
class FoundItem extends Model
{
     ...
     * Setiap barang ditemukan milik satu user
     */
     ...
     * Setiap barang ditemukan termasuk dalam satu kategori
     */
    ...
    {
        if ($this->gambar && Storage::disk('public')->exists('images/found/' . $this->gambar)) {
            return asset('storage/images/found/' . $this->gambar);
        }
